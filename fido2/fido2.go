...
func (d *Device) Assertion(
	...
	cCredentialIdLen := C.fido_assert_id_len(cAssert, cIdx)
	cCredentialIdPtr := C.fido_assert_id_ptr(cAssert, cIdx)
	credentialId := C.GoBytes(unsafe.Pointer(cCredentialIdPtr), C.int(cCredentialIdLen))
